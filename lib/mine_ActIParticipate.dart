...
class ActIParticipateTabs extends StatefulWidget {
  @override
  _ActIParticipateTabsState createState() => _ActIParticipateTabsState();
}

class _ActIParticipateTabsState extends State<ActIParticipateTabs> {
              ...
              InkWell(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => Lost_Detail()));
                },
                child: Padding(
